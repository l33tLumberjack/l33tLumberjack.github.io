...
So, let’s break this down and get the math right. The English language contains 26 lowercase and 26 uppercase characters so right there in a single 1 character string you have 52 possible charecters. Now if we consider including the numbers 0-9 that’s an additional 10 charecters with for a total of 62 and then we add the special characters which adds an additional 32 possible charecters. Wait wait wait I hear you saying 32 charecters? Bro do you even count? Yes, I do and you are not considering characters like the brackets, greater or less than and quotes as well as tilde and backtick. So, if you are not using Alt-codes, the typical QWERTY keyboard can give you a total of 94 charecters to work with. So, to do this calculation at home you take the number of charecters of your password and you rise it to the power of how many charecters in that set you have. 
